	...
	public class VendBotBlock extends BlockBase {
		
		public static final AxisAlignedBB VEND_BLOCK_BOT_AABB = new AxisAlignedBB(0, 0, 0, 1, 1, 1);
		
		public VendBotBlock(String name)
		{
